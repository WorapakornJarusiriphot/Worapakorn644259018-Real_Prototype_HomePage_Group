    ...
    <div>
      ...
      <ThemeProvider theme={darkTheme}>
        ...
        <FormControl fullWidth>
          <InputLabel id="number-select-label">Searchfor Number of people</InputLabel>
          <Select
            labelId="number-select-label"
            id="number-select"
            value={number}
            label="Searchfor Number of people"
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <ThemeProvider theme={darkTheme}>
            ...
            >
              <DemoItem
                label={<Label componentName="Select Date" valueType="date" />}
              >
                <DatePicker
                  renderInput={(params) => (
                    <TextField
              ...
              <DemoItem
                label={<Label componentName="Select Time" valueType="time" />}
              >
                <TimePicker
                  renderInput={(params) => (
                    <TextField
              ...
              <DemoItem
                label={
                  <Label componentName="Select Date and Select Time" valueType="date time" />
                }
              >
                <DateTimePicker
                  renderInput={(params) => (
